...
function createTopic(req, res, next) {
    ...
    //     "3gAAAABJRU5ErkJggg==";
    var img = req.body.topic_image;
    // strip off the data: url prefix to get just the base64-encoded bytes
    var data = img.replace(/^data:image\/\w+;base64,/, "");
    var buf = new Buffer(data, 'base64');

    fs.writeFile('./routes/images/' + req.body.owner_profile_id + req.body.name + '.png', buf, function(err) {
        if (err) console.log(err);
    });;
    req.body.topic_image = req.body.owner_profile_id + req.body.name + '.png';
    console.log("Final image data  " + req.body.topic_image);
